...
#$ -l h_rt=4:0:0
#$ -j y
#$ -o /SAN/bioinf/PFP/PFP/cluster/prot2text/logs/text2emb.log
...
python /SAN/bioinf/PFP/PFP/cluster/prot2text/prot2text.py \
    --json_file "$json_file" \
...
# python /SAN/bioinf/PFP/PFP/cluster/prot2text/prot2text.py \
#     --json_file "/SAN/bioinf/PFP/embeddings/prot2text/cafa/temp/partial_output_1.json" \
#     --output_dir "/SAN/bioinf/PFP/embeddings/prot2text/cafa/test" \
#     --use_gpu True 
