...
class ObOTools:
    ...
    def load_obo_pkl(self):
        ...
        # """Save a dictionary to a text file in a readable format."""
        # with open("obo_pkl", 'w') as f:
        #     for key, value in obo_pkl.items():
        #         f.write(f"{key}: {value}\n")
    ...
    def get_aspect(self,term:str):
        ...
        # with open("term2aspect", 'w') as f:
        #     json.dump(self.term2aspect, f)
        # exit()
        return aspect
